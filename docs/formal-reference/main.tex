...
The typed production registry contains 18 \lean{PackagedMRDT} values. The
...
\midrule
\endhead
Grow-only stores, flat counters, bounded counter, OR-Set, TreeMove,
...
The typed \lean{Production.StateGC.registry} follows the same eighteen-entry
