...
\midrule
H1, named removal & validated on honest executions; conjectured in general & no counterexample in 3000 executions, 117{,}290 versions, 21{,}375 registered-ancestor and 851 virtual-base merges, three seeds; every generated event passes a transcribed \lean{applicableB} after erasing $\mathit{kills}$; Lean proof owed \\
...
\lean{applicableB} and \lean{clockedB}; all 95{,}064 events of the three
...
not an asymptotic result. The gap at 184 operations is a factor of 82. The
...
modelling purge and before porting; it determines whether causal stability
authorises dropping the dead register, and it changes the sequential
specification.
