...
AegisSheet & \checkmark & \checkmark & open$^3$ & certificate \\
\bottomrule
\end{tabular}
...
refine FIFO. $^3$The old whole-prefix legality rejects valid concurrent
origins. Trivial-generation grow-only and counter products are also in the
ledger.}
\label{tab:instances}
\end{table}
