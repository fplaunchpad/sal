...
$e_1\mathrel{\mathsf{rc}}e_2$ when the datatype's conflict resolver chooses
...
\lean{ReplayPolicy}; the low-priority default is unconstrained, and a
specialized proof may install another policy locally. Consequently, neither
