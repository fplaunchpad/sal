...
| A production entry stores a name, a raw signature, and the complete public certificate for that exact signature. | `Metatheory/Correctness.lean`: `PackagedMRDT`; `Production/Registry.lean` | Machine-checked packaging boundary. |
