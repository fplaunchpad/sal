...
\item \textbf{The eight VCs are one instance of a closure-indexed
  ...
  bubble cannot see). All kernel-checked.
\end{enumerate}
...
at the pair's common causal base. The open step is thus sharper than
``host the RGA'': re-architect the bubble to fire each swap at that
base, consuming the semantic commutation directly. The RGA converges;
what remains is a proof architecture that can see why.
\end{openq}
