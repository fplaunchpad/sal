...
candidate is moot: ties no longer exist. Open: compression of
birth-constant coordinates (stability-gated renumbering), and the L19
backward-run column (two-sided extension), both orthogonal to
retention.
