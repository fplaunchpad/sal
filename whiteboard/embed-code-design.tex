...
encoding; the sided generalization)}
...
generation guard exactly as one-sided. Owed next: the per-policy
intent theorems at the instance (all-R read-equivalence through the
fragment theorem; Fugue non-interleaving through convexity).
