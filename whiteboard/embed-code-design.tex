...
own insertion anchor ($1$ under sequential editing) --- the
...
--- a kernel-checked read-equivalence theorem, with machine lockstep
at every step as its tested form --- with the
