...
Currently shipped: Increment-Only Counter, PN-Counter, OR-Set. The remaining 15 CRDTs are a mechanical application of the same pattern (see [`../.claude/plans/composed-strolling-mist.md`](../.claude/plans/composed-strolling-mist.md)).
