...
namespace Sal.ConditionedMRDTs.RGARefEdgeLoOnEq

open Sal.Emulation
open Sal.ConditionedMRDTs.GenericEqQuotient (loOnEq eqCommutesOn)
open Sal.ConditionedMRDTs.RGAInstance (rgaEqEquiv' WfOpA)
...
end Sal.ConditionedMRDTs.RGARefEdgeLoOnEq
