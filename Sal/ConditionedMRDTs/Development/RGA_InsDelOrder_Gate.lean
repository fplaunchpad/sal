...
namespace Sal.ConditionedMRDTs.RGAInsDelOrderGate

open Sal.Emulation
open Sal.ConditionedMRDTs
open Sal.ConditionedMRDTs.GenericEqQuotient
open Sal.ConditionedMRDTs.RGAInstance (RGACondSig' rgaEqEquiv' rgaCongVC' rgaInvInvVC')
open Sal.ConditionedMRDTs.RGAOrderBridge (doW_pos rc_is_Either')
open Classical
...
end Sal.ConditionedMRDTs.RGAInsDelOrderGate
