import Sal.ConditionedMRDTs.Development.RGA_BirthBridge_Bundle
...
namespace Sal.ConditionedMRDTs.RGABirthBridgeSplit
...
end Sal.ConditionedMRDTs.RGABirthBridgeSplit
