...
\node[ver] (p1) at (-3.2,-1.5)  {$p_1:\ \{\Ap\}\ (\{1\},\emptyset)$};
\node[ver] (q1) at (3.2,-1.5) {$q_1:\ \{\Aq\}\ (\{2\},\emptyset)$};
\node[lca] (s)  at (0,-3.1)
  {$v_s:\ \{\Ap,\Aq\}\ (\{1,2\},\emptyset)$};
\node[ver] (p2) at (-5.2,-3.1)  {$p_2:\ \{\Ap,\Rp\}\ (\{1\},\{1\})$};
\node[ver] (q2) at (5.2,-3.1) {$q_2:\ \{\Aq,\Rq\}\ (\{2\},\{2\})$};
\node[ver] (p3) at (-3.4,-4.8)
  {$\mathrm{head}_p:\ \{\Ap,\Rp,\Aq\}\ (\{1,2\},\{1\})$};
\node[ver] (q3) at (3.4,-4.8)
  {$\mathrm{head}_q:\ \{\Aq,\Rq,\Ap\}\ (\{1,2\},\{2\})$};
\node[ver] (top) at (0,-6.4)
  {$v_\top:\ (\{1,2\},\{1,2\})$};
\draw[anc] (v0) -- node[lbl, pos=0.45, above=1pt, sloped]{$\Ap$} (p1);
\draw[anc] (v0) -- node[lbl, pos=0.45, above=1pt, sloped]{$\Aq$} (q1);
\draw[anc] (p1) -- (s);
\draw[anc] (q1) -- (s);
\draw[anc] (p1) -- node[lbl, pos=0.4, above=1pt, sloped]{$\Rp$} (p2);
\draw[anc] (q1) -- node[lbl, pos=0.4, above=1pt, sloped]{$\Rq$} (q2);
\draw[anc] (p2) -- (p3);
\draw[anc] (s)  -- (p3);
\draw[anc] (q2) -- (q3);
\draw[anc] (s)  -- (q3);
\draw[anc] (p3) -- (top);
\draw[anc] (q3) -- (top);
\node[lbl, below=0.12cm of s] {$= \mathrm{LCA}(\mathrm{head}_p,
  \mathrm{head}_q)$};
\node[lbl, right=0.14cm of top] {live $\emptyset$};
\end{tikzpicture}
