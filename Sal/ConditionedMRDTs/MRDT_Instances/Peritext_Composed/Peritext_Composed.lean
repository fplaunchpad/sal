import Sal.ConditionedMRDTs.MRDT_Instances.Peritext_Composed.Supplies
...
marks literally. -/
theorem peritextComposed_ra_linearizable_up_to_eq
...
#print axioms peritextComposed_ra_linearizable_up_to_eq
