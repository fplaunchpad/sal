import Sal.ConditionedMRDTs.MRDT_Instances.RGA_TombstoneFree.RGA_Final_Assembly
import Sal.ConditionedMRDTs.MRDT_Instances.RGA_TombstoneFree.RGA_GenDisc_Assembly
...
theorem rga_hHon_discharged (hHD : HonestDelivery) :
  ...
  · -- the generation discipline, from born accuracy
    refine genDisc2C_of_born (coreR C₀) (Sal.ConditionedMRDTs.Configuration.core C₀).events lE hlE
