...
\begin{openq}[Does conditioning compose?]
\label{oq:compose}
...
compose automatically. None of this is mechanized; the map combinator and
the coupling boundaries are the roadmap's composition experiments, and
where composition \emph{breaks} is expected to be as informative as where
it holds.
\end{openq}
