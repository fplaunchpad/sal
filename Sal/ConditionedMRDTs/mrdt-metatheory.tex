...
products with at most one $\mathsf{rc}$-nontrivial component. Still open:
the $\eqobs$-lift (product of eq-quotients; the pragmatic cut $\eqobs_2 =
{=}$ suffices for the roadmap's Peritext $=$ RGA $\otimes$ marks), the
safety kit, the indexed (map-of-MRDTs) generalization, and the L2.5/L3
