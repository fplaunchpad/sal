...
(\lean{BCHonest\_iff\_genHonest}, \lean{qHonest\_of\_genHonest}). A generic
\emph{safety} metatheorem ($\Inv$ at every version from
applicability-stability) remains open; the counter's counting argument
shows the stability condition is where the per-datatype content will
sit.
