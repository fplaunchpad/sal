...
first. This is forced: VC~\ref{vc:disc}'s directionality plus
\textsc{no-rc-chain} orient every non-commuting concurrent pair while
forbidding length-2 paths, and any orientation of a \emph{self}-conflicting
