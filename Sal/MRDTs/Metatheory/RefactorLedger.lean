...
import Sal.MRDTs.Instances.QueueContractSPOT
import Sal.MRDTs.Instances.MVRContractSPOT
import Sal.MRDTs.Instances.MVRLiveSPOT
...
import Sal.MRDTs.Instances.FugueMaxSequentialSPOT
...
#check Instances.Queue.replayAdequacy
#check Instances.Queue.queue_replay_witness
#check Instances.Queue.replayAdequate
#check Instances.Queue.issued_dequeue_no_visible_dequeue
#check Instances.Queue.duplicate_dequeues_concurrent
#check Instances.Queue.queue_version_contents
#check Instances.Queue.client_linear_fifo
#check Instances.Queue.queue_correct
#check Instances.Queue.queue_versions_sorted
#check Instances.Queue.queue_legal_witness
#check Instances.Queue.verified
#check Instances.Queue.ContractSPOT.lo_eq_loOn
#check Instances.Queue.ContractSPOT.extra_pop_rejected
#check Instances.Queue.ContractSPOT.fork_duplicate_witness
...
#check Instances.SidedEmbedRGA.FugueMax.insertion_issuance_exact
#check Instances.SidedEmbedRGA.FugueMax.deletion_issuance_exact
#check Instances.SidedEmbedRGA.FugueMax.rawFold_exact
#check Instances.SidedEmbedRGA.FugueMax.issuer_merge_refines
#check Instances.SidedEmbedRGA.FugueMax.invariants_of_mint
#check Instances.SidedEmbedRGA.FugueMax.join_of_mint
#check Instances.SidedEmbedRGA.FugueMax.replayAdequacy
#check Instances.SidedEmbedRGA.FugueMax.replay_noninterleaving
#check Instances.SidedEmbedRGA.FugueMax.fmChainBefore_snocR_iff
#check Instances.SidedEmbedRGA.FugueMax.fmChainBefore_snocL_iff
#check Instances.SidedEmbedRGA.FugueMax.exists_chain_construction
#check Instances.SidedEmbedRGA.FugueMax.births_refine
#check Instances.SidedEmbedRGA.FugueMax.listLegal
#check Instances.SidedEmbedRGA.FugueMax.listSpec
#check Instances.SidedEmbedRGA.FugueMax.listRel
#check Instances.SidedEmbedRGA.FugueMax.verified
#check Instances.SidedEmbedRGA.FugueMax.correct
#check Instances.SidedEmbedRGA.FugueMax.IssuerSPOT.finite_guard_rejects_wrong
