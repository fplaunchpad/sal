...
namespace Sal.Metatheory.RGASkeleton2
...
open Sal.Metatheory.RGASkeleton (EngineReady canonMatch_of_engineReady)
open Sal.Metatheory.RGACorrectedResidual (canonFoldOK_concat rga_eqJoinNF_of_canon2)
...
theorem rga_RA_linearizable_end_to_end2
  ...
  Sal.Metatheory.RGAInstanceNF.rga_RA_linearizable_NF
...
end Sal.Metatheory.RGASkeleton2
