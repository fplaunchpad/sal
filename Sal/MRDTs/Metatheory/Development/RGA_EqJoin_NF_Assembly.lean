import Sal.MRDTs.Metatheory.Development.RGA_EqJoin_NF_Residual
...
namespace Sal.Metatheory.RGAEqJoinNF
...
`Sal.Metatheory.RGAInstanceNF.rga_RA_linearizable_NF` (`hJoinNF : EqJoinLemma3C_NF … WfOpA`), giving
...
end Sal.Metatheory.RGAEqJoinNF
