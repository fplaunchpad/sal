import Sal.MRDTs.Metatheory.Development.RGA_HEnum_Discharge
import Sal.MRDTs.Metatheory.Development.RGA_MergeCanon_Fix
import Sal.MRDTs.Metatheory.Development.RGA_BranchCanon
...
open Sal.Metatheory.RGAMergeCanon (merge_domain_clause)
...
theorem rga_hbridge_discharged
  ...
  have hcatOK : CanonFoldOK [] init_st (ρ₀ ++ π₀) :=
    Sal.Metatheory.RGACorrectedResidual.canonFoldOK_concat ρ₀ [] init_st π₀ h₀OK hπOK
