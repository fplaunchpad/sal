import Sal.MRDTs.Metatheory.Development.RGA_EnablementBase
import Sal.MRDTs.Metatheory.Development.ConditionedExecutionModel
...
namespace Sal.Metatheory.RGAUpdateConvergence
...
theorem RGA_update_convergence
    ...
    (h₁r : respects π₁ (Sal.Metatheory.ConditionedConvergence.loOnA RGACondSig Cfg E))
    (h₂r : respects π₂ (Sal.Metatheory.ConditionedConvergence.loOnA RGACondSig Cfg E))
...
end Sal.Metatheory.RGAUpdateConvergence
