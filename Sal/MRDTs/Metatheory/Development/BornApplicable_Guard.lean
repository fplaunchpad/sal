...
import Sal.MRDTs.Metatheory.Development.RGA_InvUpdateQ
...
open Sal.Metatheory.RGAInvUpdateQ (WfOpQ qInv_doOp rgaInvPresQ WfOpGenQ
...
theorem rga_appOrNoop_qsig (hC : CongVC RGACondSig' rgaEqEquiv')
    ...
    Sal.Metatheory.ConditionedConvergence.appOrNoop
