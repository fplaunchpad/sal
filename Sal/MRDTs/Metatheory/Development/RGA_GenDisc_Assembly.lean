import Sal.MRDTs.Metatheory.Development.RGA_GenDisc_Peel
...
theorem genDisc2C_of_born_aux (Cfg : Sal.Emulation.Configuration RGACondSig.toCRDTSig)
  ...
  | succ n ih =>
    ...
    have happW : RGACondSig.applicable o (applySeqR init_st (d ++ N)) :=
      ⟨(Sal.Metatheory.RGAEqQuotient.accurate_eq_iff o heqf).mp happπ.1,
       (Sal.Metatheory.RGAEqQuotient.fresh_ts_eq_iff o heqf).mp happπ.2⟩
