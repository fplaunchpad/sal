...
theorem goodConfig_of_mintCertified {D : MRDTSig} {I : Issuance D}
    (join : ∀ C, MintHonest D I.CanIssue C → JoinLemma3At D C.core)
    {C : Configuration D} (reach : MintCertifiedReach D I C) : GoodConfig3 C := by
...
theorem ra_of_mintCertified {D : MRDTSig} {I : Issuance D}
    (join : ∀ C, MintHonest D I.CanIssue C → JoinLemma3At D C.core)
...
theorem goodConfig_of_mintCertifiedV {D : MRDTSig} {I : Issuance D}
    (join : ∀ C, MintHonest D I.CanIssue C → JoinLemma3At D C.core)
    {C : Configuration D}
    (reach : MintCertifiedReachV D (canonicalVirtualLCA D) I C) :
    GoodConfig3 C := by
...
theorem ra_of_mintCertifiedV {D : MRDTSig} {I : Issuance D}
    (join : ∀ C, MintHonest D I.CanIssue C → JoinLemma3At D C.core)
    {C : Configuration D}
    (reach : MintCertifiedReachV D (canonicalVirtualLCA D) I C) :
    IsRALinearizableJoin C :=
