...
\lean{MRDT\_Instances\_Generic.lean}), the tombstone-free RGA at full
generality. The contract-tier column is each data type's Join-Lemma
discharge content (\lean{MRDT\_Instances.lean}); the historical flat
...
flat collapse of the framework & \lean{eqJoinH\_of\_joinC}, \lean{flat\_ra\_linearizable3\_eq} & \lean{Conditioned/FlatGeneric\_Bridge.lean} \\
the nine flat instances, generically & \lean{$\ast$\_ra\_linearizable3\_eq} (9) & \lean{MRDT\_Instances\_Generic.lean} \\
\bottomrule
\end{tabular}}
\end{center}
