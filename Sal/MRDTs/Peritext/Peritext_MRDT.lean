...
The read-side projection and paper-semantic characterization theorems
live in [`Peritext_ReadSide.lean`](Peritext_ReadSide.lean), which
imports this file. Split for iteration speed.
-/
