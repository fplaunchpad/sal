...
- [`docs/metatheory-note/mrdt-metatheory-note.pdf`](docs/metatheory-note/mrdt-metatheory-note.pdf) — the ternary companion note: the MRDT metatheory in paper style — the eight VCs with intuition, the delta contract and why no lattice contract can exist, the causal-delta equation, the LCA lemma erratum, and the discharged production catalogue, with TikZ execution diagrams.
