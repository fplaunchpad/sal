...
\begin{frame}
  \frametitle{AI-Assisted Verification: Real-World Integration}
  
  \centering
  \includegraphics[width=0.5\textwidth]{Pictures/kc_commits.png}
  \small\textit{Integration commits}
  
  \vspace{0.2cm}
  \includegraphics[width=0.5\textwidth]{Pictures/peritext_commit.png}
  \small\textit{Peritext verification}
  
  \vspace{0.2cm}
  \includegraphics[width=0.5\textwidth]{Pictures/verified_status.png}
  \small\textit{Verification status}
  
  \vspace{0.2cm}
  \tiny Practical deployment of AI-assisted theorem proving in the \sal framework
\end{frame}
